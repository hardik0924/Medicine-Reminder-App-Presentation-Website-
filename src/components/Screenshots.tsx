...
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-3 shadow-2xl group-hover:-translate-y-2 group-hover:shadow-xl transition-transform duration-300">
...
                      <button className="flex-1 bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg text-sm transition-colors">Mark Taken</button>
                      <button className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-4 rounded-lg text-sm transition-colors">Snooze</button>
                    </div>
                  </div>
                </div>
              </div>
...
                        <select className="w-full p-2 border rounded text-sm cursor-pointer">
...
                      </div>
                    </div>
                    <button className="w-full bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-lg mt-4 text-sm transition-colors">Save Prescription</button>
                  </div>
                </div>
              </div>
            </div>
...
                      ))}
                    </div>
                    <button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded-lg mb-3 text-sm transition-colors">Verify & Login</button>
                    <button className="w-full text-blue-500 hover:underline py-2 text-sm">Resend Code</button>
                  </div>
                </div>
              </div>
            </div>
